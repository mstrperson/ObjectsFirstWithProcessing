...
void setup()
{
  frameRate(60);
  fullScreen();
  brakes = new UniformForce(1);
  blackHole = new BlobWithMass(new Vector2(2*width/3, height/2), 10, color(200, 180,0), 100+random(150));
  blackHole2 = new BlobWithMass(new Vector2(width/3, height/2), 10, color(255,128,80), 100+random(150));
